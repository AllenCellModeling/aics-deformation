...
Report bugs at https://github.com/AllenCellModeling/aicsdeformation/issues.
...
aics-deformation could always use more documentation, whether as part of the
official aics-deformation docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/AllenCellModeling/aicsdeformation/issues.
...
Ready to contribute? Here's how to set up `aicsdeformation` for local development.

1. Fork the `aicsdeformation` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/aicsdeformation.git
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/AllenCellModeling/aicsdeformation/pull_requests
...
$ py.test tests.test_aicsdeformation
